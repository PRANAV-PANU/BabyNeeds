...
public class RecyclerViewAdapter extends Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.size.setText(MessageFormat.format("Size: {0}", Integer.toString(item.getItemSize())));
        viewHolder.quantity.setText(MessageFormat.format("Qty: {0}", Integer.toString(item.getItemQuantity())));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        public TextView quantity,size,itemName,itemColor,dateAdded;
